...
- Выбор A2, A3 или A4 и книжной либо альбомной ориентации при создании текстового документа.
- Лист расположен по центру редактора и автоматически масштабируется по доступной ширине
  при изменении размеров окна; текущий масштаб виден в строке состояния.
- Вставка изображения из контекстного меню редактора.
- Встроенная справка Markdown с примерами синтаксиса и ограничениями предпросмотра.
