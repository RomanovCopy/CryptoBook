...
> **Важно для версии 1.1.2.5:** если после обновления CryptoBook перестал
> запускаться, встроенный обновлятор тоже недоступен. Вручную скачайте и
> запустите [установщик 1.1.2.51](https://github.com/RomanovCopy/CryptoBook/releases/tag/v1.1.2.51)
> поверх существующей установки. Подробности — в
> [инструкции по восстановлению](docs/releases/v1.1.2.5-recovery.md).
...
Основные изменения версий перечислены в [CHANGELOG.md](CHANGELOG.md).
