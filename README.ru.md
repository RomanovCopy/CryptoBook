...
Скриншоты версии 1.1.3.3 содержат демонстрационные материалы.
[Описание съёмки и примеры документов](docs/screenshots/README.md).

## Новое в 1.1.3.4

- Масштабирование текстового редактора сочетанием Ctrl + колесо мыши.
- Кнопка **100%** рядом с индикатором масштаба возвращает фактический масштаб страницы.
- Масштабирование изменяет только отображение: размер страницы, шрифты и содержимое сохраняются.
- При изменении ширины окна сохраняется коэффициент увеличения относительно автоматического
  вписывания по ширине. Процент масштаба может измениться, в том числе после сброса до 100%.

Подробнее — в [описании релиза](docs/releases/v1.1.3.4.md) и [истории изменений](CHANGELOG.md).
